...
describe('PostsController', () => {
    ...
    describe('GET /posts', () => {
        ...
        it('should return an array with posts', () => {
            const result: Array<PostEntity> = postArrayMock;
    ...
    describe('GET /posts/:id', () => {
        it('should throw NotFoundException', () => {
            expect(() => controller.get('1423425')).toThrowError();
        });

        it('should return a post', () => {
            const result: PostEntity = postMock;
            jest.spyOn(service, 'findOne').mockImplementation(() => result);
            expect(controller.get('2342342342')).toBe(result);
        });
    });
});
